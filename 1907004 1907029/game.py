...
class Game:
    ...
    def fuzzy_evaluate(self,value_difference):
        ...
        # Adjust weights for the new range
    ...
    def evaluate_human_move(self, human_move):
        ...
        # print(value_difference,move_quality)

        if move_quality >= 50:
            message = "Very good move!"
        elif 10 <= move_quality < 50:
            message = "Good move!"
        elif -10 <= move_quality < 10:
            message = "Bad move."
        else:
    ...
    def show_sidebar(self,surface, message):
        # Define the sidebar's rectangle
        sidebar_rect = pygame.Rect(COLS * SQSIZE, 0, SIDEBAR_WIDTH, height)
        
        # Fill the sidebar with a background color
        pygame.draw.rect(surface, (200, 200, 200), sidebar_rect)
        ...
        # Calculate position to center the text in the sidebar
        text_rect = text_surface.get_rect()
        text_rect.topleft = (COLS * SQSIZE + SIDEBAR_PADDING, SIDEBAR_PADDING)
        
        # Blit the text onto the sidebar
