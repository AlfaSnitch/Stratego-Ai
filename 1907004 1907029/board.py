...
class Board:
    ...
    def minimax(board, depth, alpha, beta, maximizing_player):
        if depth == 0 or board.gameover_by_notmoving() or board.gameover_by_win():
...
'''
    ...
    def gameover_by_win(self):
        f = 0
        for row in self.squares:
            for square in row:
                piece = square.piece
                
                if isinstance(piece,Flag):
                    f+=1
        print(f)
        if f==3:
            return True
    ...
    def _add_pieces(self,color):
        ...
        grids =[[ 
                 ...
                 ['bomb', 'scout', 'lieutenant', 'scout', 'lieutenant', 'captain', 'bomb', 'lieutenant', 'major', 'bomb'],
                 ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'],
                 ['captain', 'scout', 'colonel', 'marshal', 'major', 'scout', 'colonel', 'bomb', 'scout', 'spy']
                ],
               [['sergeant', 'miner', 'miner', 'sergeant', 'miner', 'miner', 'miner', 'sergeant', 'bomb', 'flag'], ['bomb', 'scout', 'lieutenant', 'scout', 'lieutenant', 'captain', 'bomb', 'lieutenant', 'major', 'bomb'], ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'], ['captain', 'scout', 'colonel', 'marshal', 'major', 'scout', 'colonel', 'bomb', 'sergeant', 'spy']],
               [['sergeant', 'miner', 'miner', 'bomb', 'flag', 'bomb', 'miner', 'sergeant', 'sergeant', 'miner'], 
                ['miner', 'scout', 'lieutenant', 'scout', 'bomb', 'captain', ' lieutenant ', 'lieutenant', 'major', 'bomb'], 
                ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'], 
                ['captain', 'scout', 'colonel', 'marshal', 'major', 'scout', 'colonel', 'bomb', 'sergeant', 'spy']],
               
               [['sergeant', 'miner', 'miner', 'sergeant', 'sergeant', 'miner', 'bomb', 'flag', 'bomb', 'miner'], 
                ['miner', 'scout', 'lieutenant', 'scout', 'lieutenant', 'captain', 'lieutenant', 'bomb', 'major', 'bomb'], 
                ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'], 
                ['captain', 'scout', 'colonel', 'marshal', 'major', 'scout', 'colonel', 'bomb', 'sergeant', 'spy']],
               
               [['sergeant', 'bomb', 'flag', 'bomb', 'sergeant', 'miner', 'sergeant', 'miner', 'miner', 'miner'], 
                ['miner', 'scout', 'bomb', 'scout', 'lieutenant', 'captain', 'lieutenant', 'bomb', 'major', 'lieutenant'], 
                ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'], 
                ['scout', 'colonel', 'sergeant', 'marshal', 'captain', 'spy', 'major', 'scout', 'bomb', 'colonel']],
               [['sergeant', 'miner', 'miner', 'bomb', 'flag', 'bomb', 'miner', 'sergeant', 'sergeant', 'miner'], 
                ['miner', 'scout', 'lieutenant', 'scout', 'bomb', 'captain', 'lieutenant', 'lieutenant', 'major', 'bomb'], 
                ['scout', 'major', 'scout', 'lieutenant', 'scout', 'captain', 'captain', 'spy', 'general', 'bomb'], 
                ['sergeant', 'spy', 'captain', 'major', 'bomb', 'scout', 'scout', 'colonel', 'marshal', 'colonel']]
